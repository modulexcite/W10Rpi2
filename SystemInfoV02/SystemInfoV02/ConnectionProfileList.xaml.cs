...
namespace SystemInfoV02
{
    ...
    public sealed partial class ConnectionProfileList
    {
        ...
        private void ConnectionProfileList_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                OutputText.Text = connectionProfileList;
            }
        ...
        {
            var dataplanStatusInfo = "Dataplan Status Information:\n";
            dataplanStatusInfo += "====================\n";
            ...
            DateTimeOffset? nextBillingCycle = dataPlan.NextBillingCycle;
